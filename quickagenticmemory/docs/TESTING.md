...
| Infrastructure static checks | Bicep compilation/linting, shell syntax, workflow structure, secret scanning, GitHub access controls, OneLake failure/retry/idempotency behavior, and bounded Fabric `RefreshGraph` job mocks. | `npm run verify:infra` |
